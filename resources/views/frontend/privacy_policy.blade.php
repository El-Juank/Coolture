    ...
    <section id="privacy">
        <div class="container generic-container" data-aos="fade-up">
            <div class="section-header">
                <h2>{{ __('lang.privacy_policy_title') }}</h2>
            </div>
            <p>COOLTURE built the COOLTURE app as a free app. This SERVICE is provided by COOLTURE [at no cost] and is
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
                which is accessible at COOLTURE, unless otherwise defined in this Privacy Policy.</p>

            <p><strong>{{ __('lang.privacy_policy_subtitle1') }}</strong></p>
            <p>For a better experience while using our Service, we may require you to provide us with certain
                personally identifiable information, including but not limited to [add whatever else you collect here, e.g.
                users name | address | location | pictures].
            ...
            <p><strong>{{ __('lang.privacy_policy_subtitle2') }}</strong></p>
            ...
            <p><strong>{{ __('lang.privacy_policy_subtitle3') }}</strong></p>
            ...
            <p><strong>{{ __('lang.privacy_policy_subtitle4') }}</strong></p>
            ...
            <p><strong>{{ __('lang.privacy_policy_subtitle5') }}</strong></p>
            <p>We value your trust in providing us your Personal Information, thus we are striving to use
                commercially acceptable means of protecting it. But remember that no method of transmission over
                the internet, or method of electronic storage is 100% secure and reliable, and we cannot
                guarantee its absolute security.</p>

            <p><strong>{{ __('lang.privacy_policy_subtitle6') }}</strong></p>
            ...
            <p><strong>{{ __('lang.privacy_policy_subtitle7') }}</strong></p>
            ...
            <p><strong>{{ __('lang.privacy_policy_subtitle8') }}</strong></p>
            <p>We may update our Privacy Policy from time to time. Thus, you are advised to review this page
                periodically for any changes. We will notify you of any changes by posting the new Privacy Policy
                on this page. These changes are effective immediately, after they are posted on this page.</p>

            <p><strong>{{ __('lang.privacy_policy_subtitle9') }}</strong></p>
