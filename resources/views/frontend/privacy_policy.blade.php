...
@section('seoTitle')
    | {{ __('lang.privacy_policy_seo_title') }}
@endsection
...
@section('content')
    <section id="privacy">
        <div class="container generic-container" data-aos="fade-up">
            ...
            <p>The app does use third party services that may collect information used to identify you. [You can mention
                Google
            ...
            <p>Cookies are files with small amount of data that is commonly used an anonymous unique identifier.
                ...
                internal memory.</p>
            <p>>!-- Check if this is true for your app, if unsure, just assume that you do use cookies and modify this next
                line
